...
Physicist turned software developer, working toward robotics and autonomous systems engineering.

I graduated with First Class Honours in Physics from the University of Hertfordshire and
...
**ML & Scientific:** PyTorch, TensorFlow, NumPy, SciPy, Pandas, matplotlib  
**Methods:** Monte Carlo / MCMC, ODE/PDE integration, numerical linear algebra  
**Robotics:** ROS 2 (nodes, topics, services, launch), CMake, control systems  
...
- 🔬 Research: ML + MCMC for phase transitions in the 2D Ising model
- 🤖 Currently studying: SLAM, sensor fusion, embedded C++
